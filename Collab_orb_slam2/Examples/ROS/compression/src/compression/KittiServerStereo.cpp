...
void signal_handler(int signal)
{
	...
	SLAM->SaveMapPoints("mapOutput.txt");
...
int main(int argc, char **argv)
{
	...
	SLAM->InitAgent(1, strSettingsFile1, CORB_SLAM2::Sensor::STEREO, bUseViewer);
	SLAM->InitAgent(2, strSettingsFile1, CORB_SLAM2::Sensor::STEREO, bUseViewer);

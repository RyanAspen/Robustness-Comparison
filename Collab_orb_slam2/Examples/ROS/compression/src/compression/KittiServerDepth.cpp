...
void signal_handler(int signal)
{
	...
	std::cout << "signal_handler called with signal: " << signal << std::endl;
...
int main(int argc, char **argv)
{
	...
	SLAM->InitAgent(1, strSettingsFile1, CORB_SLAM2::Sensor::RGBD, bUseViewer);
	SLAM->InitAgent(2, strSettingsFile1, CORB_SLAM2::Sensor::RGBD, bUseViewer);
